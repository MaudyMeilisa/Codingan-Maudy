...
<form>
    <br>
    <center> <h2>Pengulangan</h2>
    <p>1.Bilangan ganjil</p>
    <p>2.Segitiga sama kaki terbalik</p>
    <p>3.Deret bilangan kelipatan 3</p></center>
    <div class ="container">
  <div class="form-group">
    <label for="angka">pilih</label>
    <input type="text" class="form-control" id="pilih" name='pilih'>
...
if(isset($_POST['simpan'])){
    ...
    $angka = $_POST['angka'];
    if ($pilih == 1){
        echo "<b>1. Deret Bilangan Ganjil<br></b>";
        for($i=1; $i <= $angka; $i++){
            if ($i %2 == 0) { 
             } else {
                echo"$i ";
    ...
    echo "<b>2. Segitiga Sama Kaki Terbalik<br></b>";
        $star=$angka;
	for($a=1; $a<=$star; $a++){
	for($b=1; $b<=$a; $b++){
    echo"&nbsp";
	...
	echo "<br>";
        ...
        echo "<b>3. Deret Bilangan Kelipatan 3<br></b>";
        for($i=1; $i <= $angka; $i++){
            if ($i %3 == 0) {        
        echo "$i ";
    } 
